 ...
 * Use the {@link ronde1results#newInstance} factory method to
...
public class ronde1results extends Fragment {
    ...
    public static ronde1results newInstance(String param1, String param2) {
        ronde1results fragment = new ronde1results();
