 ...
 * Use the {@link gameresults#newInstance} factory method to
...
public class gameresults extends Fragment {
    ...
    public static gameresults newInstance(String param1, String param2) {
        gameresults fragment = new gameresults();
