 ...
 * Use the {@link ronde3results#newInstance} factory method to
...
public class ronde3results extends Fragment {
    ...
    public static ronde3results newInstance(String param1, String param2) {
        ronde3results fragment = new ronde3results();
